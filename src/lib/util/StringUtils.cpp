...
const map<string, string> StringUtils::BASIC_ESCAPE{
    {"\"", "&quot;"}, // " - double-quote
    {"&", "&amp;"},   // & - ampersand
    {"<", "&lt;"},    // < - less-than
    {">", "&gt;"},    // > - greater-than
};
const map<string, string> StringUtils::ISO8859_1_ESCAPE{
    {"\u00A0", "&nbsp;"},   // non-breaking space
...
const map<string, string> StringUtils::HTML40_EXTENDED_ESCAPE{
    // <!-- Latin Extended-B -->
...
void StringUtils::escapeHtml4(string &str)
{
    string buf;
